exports.categoryDecline = (name, categoryName) => {
	return `<!DOCTYPE html>
    <html>
    ...
    <body>
        <div class="container">
            ...
            <div class="body">
                <p>Hey ${name},</p>
                <p>Your Request for creating category <span class="highlight">${categoryName}</span> was Approved.
                </p>
                <p>You can just login and create courses.</p>
            </div>
